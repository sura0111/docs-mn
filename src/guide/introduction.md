...
Сонголтын API-ийн тусламжтайгаар бид, `data`, `methods` болон `mounted` гэх мэт сонголтын объектыг ашиглан компонентийн логикийг тодорхойлдог. Сонголтоор тодорхойлсон пропертинууд нь, функц дотор `this`-руу хандах байдлаар ашиглах боломжтой. Өөр үгээр `this` нь компонентийн инстанс-г илэрхийлж байгаа:
